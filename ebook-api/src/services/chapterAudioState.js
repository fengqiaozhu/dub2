...
function buildChapterAudioItems(chapter, dialogues, taskMap = new Map()) {
  ...
  return sourceItems
    .filter((dialogue) => dialogue.content && dialogue.char_start >= 0 && dialogue.char_end > dialogue.char_start)
    .map((dialogue) => {
      ...
      return {
        ...
        audio_status: resolveAudioStatus(dialogue, sourceHash),
